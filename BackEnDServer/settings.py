...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "StickyNotes/StickyNotesFrontEnD/dist/"),
            os.path.join(
                BASE_DIR, "StickyNotes/StickyNotesFrontEnD/dist/assets/"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "StickyNotes/StickyNotesFrontEnD/dist/"),
    os.path.join(BASE_DIR, "StickyNotes/StickyNotesFrontEnD/dist/assets/"),
]
